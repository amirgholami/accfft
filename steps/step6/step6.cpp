...
void solution(double* u_true,double * u_0, double T, int *N, accfft_plan* plan, MPI_Comm c_comm ){
...
void step6(int *n, int nthreads) {
  ...
  accfft_plan * plan=accfft_plan_dft_3d_r2c(n,u,(double*)u_hat,c_comm,ACCFFT_MEASURE);
  setup_time+=MPI_Wtime();
