...
void step1_gpu(int *n) {
  ...
  cudaMemcpy(data, data_cpu, isize[0]*isize[1]*isize[2]*sizeof(float), cudaMemcpyHostToDevice);
  ...
  cudaMemcpy(data2_cpu, data2, isize[0]*isize[1]*isize[2]*sizeof(float), cudaMemcpyDeviceToHost);
