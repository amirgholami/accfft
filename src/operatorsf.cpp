...
template void biharmonic_mult_wave_number<Complexf>(Complexf* wA, Complexf* A, int* N,MPI_Comm c_comm );
...
template void accfft_biharmonic_t<float,accfft_planf>(float * BA,float *A,accfft_planf *plan, double* timer);
